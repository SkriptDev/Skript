...
public class EvtExperienceChange extends SkriptEvent {
	...
	static {
		Skript.registerEvent("Experience Change", EvtExperienceChange.class, PlayerExpChangeEvent.class,
			...
			.examples("on level progress change:",
				...
				"\tbroadcast \"%{_xp}%\"")
			.since("2.7");
		EventValues.registerEventValue(PlayerExpChangeEvent.class, Number.class, new Getter<>() {
			@Override
			public @NotNull Number get(PlayerExpChangeEvent event) {
