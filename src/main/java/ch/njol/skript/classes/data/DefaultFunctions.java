...
public class DefaultFunctions {
	...
	static {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("floor", numberParam, DefaultClasses.LONG, true) {
			@Override
		...
		Functions.registerFunction(new SimpleJavaFunction<>("round", new Parameter[]{new Parameter<>("n", DefaultClasses.NUMBER, true, null), new Parameter<>("d", DefaultClasses.NUMBER, true, new SimpleLiteral<Number>(0, false))}, DefaultClasses.NUMBER, true) {
			@Override
		...
		Functions.registerFunction(new SimpleJavaFunction<>("ceil", numberParam, DefaultClasses.LONG, true) {
			@Override
			public Long[] executeSimple(Object[][] params) {
				if (params[0][0] instanceof Long)
					return new Long[]{(Long) params[0][0]};
		...
		Functions.registerFunction(new SimpleJavaFunction<>("ceiling", numberParam, DefaultClasses.LONG, true) {
			@Override
			public Long[] executeSimple(Object[][] params) {
				if (params[0][0] instanceof Long)
					return new Long[]{(Long) params[0][0]};
		...
		Functions.registerFunction(new SimpleJavaFunction<>("abs", numberParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("mod", new Parameter[]{new Parameter<>("d", DefaultClasses.NUMBER, true, null), new Parameter<>("m", DefaultClasses.NUMBER, true, null)}, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("exp", numberParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("ln", numberParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("log", new Parameter[]{new Parameter<>("n", DefaultClasses.NUMBER, true, null), new Parameter<>("base", DefaultClasses.NUMBER, true, new SimpleLiteral<Number>(10, false))}, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("sqrt", numberParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("sin", numberParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("cos", numberParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("tan", numberParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("asin", numberParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("acos", numberParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("atan", numberParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
		...
		Functions.registerFunction(new SimpleJavaFunction<>("atan2", new Parameter[]{
		...
		Functions.registerFunction(new SimpleJavaFunction<>("sum", numbersParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
				Object[] ns = params[0];
		...
		Functions.registerFunction(new SimpleJavaFunction<>("product", numbersParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
				Object[] ns = params[0];
		...
		Functions.registerFunction(new SimpleJavaFunction<>("max", numbersParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
				Object[] ns = params[0];
		...
		Functions.registerFunction(new SimpleJavaFunction<>("min", numbersParam, DefaultClasses.NUMBER, true) {
			@Override
			public Number[] executeSimple(Object[][] params) {
				Object[] ns = params[0];
		...
		Functions.registerFunction(new SimpleJavaFunction<>("clamp", new Parameter[]{
		...
		Functions.registerFunction(new SimpleJavaFunction<>("world", new Parameter[]{
		...
		Functions.registerFunction(new JavaFunction<>("location", new Parameter[]{
			new Parameter<>("x", DefaultClasses.NUMBER, true, null),
			new Parameter<>("y", DefaultClasses.NUMBER, true, null),
			...
			public Location[] execute(FunctionEvent<?> e, Object[][] params) {
				...
				World world = params[3].length == 1 ? (World) params[3][0] : Bukkit.getWorlds().getFirst(); // fallback to main world of server
		...
		Functions.registerFunction(new SimpleJavaFunction<>("date", new Parameter[]{
		...
		Functions.registerFunction(new SimpleJavaFunction<>("calcExperience", new Parameter[]{
		...
		Functions.registerFunction(new SimpleJavaFunction<>("player", new Parameter[]{
				...
				new Parameter<>("getExactPlayer", DefaultClasses.BOOLEAN, true, new SimpleLiteral<>(false, true)) // getExactPlayer -- grammar ¯\_ (ツ)_/¯
		...
		Functions.registerFunction(new SimpleJavaFunction<>("concat", new Parameter[]{
		...
		Functions.registerFunction(new SimpleJavaFunction<>("enchantmentOffer", new Parameter[]{
				...
				public @Nullable EnchantmentOffer[] executeSimple(Object[][] params) {
					Enchantment enchantment = (Enchantment) params[0][0];
					int level = ((Number) params[1][0]).intValue();
