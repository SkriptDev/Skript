...
public class RegistryClassInfo<R extends Keyed> extends ClassInfo<R> {
	...
	public RegistryClassInfo(Class<R> registryClass, Registry<R> registry, String codeName) {
		this(registryClass, registry, codeName, new EventValueExpression<>(registryClass));
	}
