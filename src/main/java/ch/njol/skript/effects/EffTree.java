 ...
 */
@Name("Tree")
@Description({"Creates a tree. This may require that there is enough space above the given location and that the block below is dirt/grass,",
...
public class EffTree extends Effect {
	...
	static {
		Skript.registerEffect(EffTree.class,
				"(grow|create|generate) [a] %treetype% %directions% %locations%");
	}
