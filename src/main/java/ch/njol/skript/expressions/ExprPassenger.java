...
public class ExprPassenger extends SimpleExpression<Entity> { // REMIND create 'vehicle' and 'passenger' expressions for vehicle enter/exit events?
	static { // It was necessary to convert to SimpleExpression due to the method 'isSingle()'.
		Skript.registerExpression(ExprPassenger.class, Entity.class, ExpressionType.PROPERTY,
	...
	public Class<?>[] acceptChange(final ChangeMode mode) {
		if (!isSingle())
			return new Class[]{Entity[].class, EntityType[].class}; // To support more than one entity
		if (mode == ChangeMode.SET)
			return new Class[]{Entity.class, EntityType.class};
				...
				switch (mode) {
					...
					case ADD:
						...
						for (Object obj : delta) {
							if (obj == null)
								continue;
							Entity passenger = obj instanceof Entity ? (Entity) obj : vehicle.getWorld().spawnEntity(vehicle.getLocation(), (EntityType) obj);
