...
//
//	static {
//		register(ExprColorOf.class, Color.class, "colo[u]r[s]", "blocks/itemstacks/entities/fireworkeffects");
//	}
//
...
//			if (o instanceof Item || o instanceof ItemStack) {
//				ItemStack stack = o instanceof Item ? ((Item) o).getItemStack() : ((ItemStack) o);
//
//				if (stack == null)
//					continue;
//
