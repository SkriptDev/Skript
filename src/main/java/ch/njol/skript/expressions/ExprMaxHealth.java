 ...
 */
@Name("Max Health")
@Description("The maximum health of an entity, e.g. 20 for a player.")
@Examples({"on join:",
...
public class ExprMaxHealth extends SimplePropertyExpression<LivingEntity, Number> {
	...
	public void change(final Event e, final @Nullable Object[] delta, final ChangeMode mode) {
		double d = delta != null && delta[0] instanceof Number num ? num.doubleValue() : 0;
