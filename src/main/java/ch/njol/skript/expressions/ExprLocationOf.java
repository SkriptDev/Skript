 ...
 */
@Name("Location Of")
@Description({"The location of a block or entity.",
	"This not only represents the x, y and z coordinates of the location but also includes the world and the direction an entity is looking " +
